...
class Block(Button):
    def __init__(self, position=(0, 0, 0), block_type=1):
        super().__init__(
            ...
            model='cube',
            origin_y=0.5,
            # Apply the correct texture based on block_type
            texture=f'textures/grass_texture.png' if block_type == 2 else 'white_cube',  # Apply grass texture for block_type 2
